 ...
 * =============================================================================
 * 
 * ⚠️ WARNING: THIS MODULE IS CURRENTLY NON-FUNCTIONAL
 * 
 * The HTTP checker cannot compute the required `cres` (challenge response)
 * value needed for Rakuten's authentication. The `cres` is generated by
 * client-side JavaScript using a proprietary algorithm that hasn't been
 * reverse-engineered.
 * 
 * Error you will see: "WRONG_VERIFICATION_CODE" on field "challengeCres"
 * 
 * Use Puppeteer checker instead: Set USE_HTTP_CHECKER=false (default)
 * 
 * See HTTP_TESTING.md for technical details on what would be needed to fix this.
 * 
 * =============================================================================
 */
